...
# Because it's written in a silly way, there are a bunch of edge cases of
# sorts.
...
def show_song(inp="Winner"):  # default winner ...
    # but also could be something else if it works correctly,
...
# 0:94: execution error: "https://itunes.apple.com/us/album/bears-adventure/
# id495954957?i=495955054&uo=4" doesn’t
# understand the “open location” message. (-1708)
# That's an Apple-related error but will not cause you a problem. Don't
# worry about it.
